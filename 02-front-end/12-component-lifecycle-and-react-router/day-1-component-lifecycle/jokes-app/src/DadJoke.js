...
class DadJoke extends React.Component {
  ...
  // Para garantir que algo só rode depois do estado ser atualizado passamos como segundo parâmetro da this.setState uma callback com a dita lógica!
  ...
  saveJoke() {
    ...
    // Para atualizar arrays no estado com base no estado anterior use o spread operator! this.setState(({ meuArrayNoEstado }) => ({meuArrayNoEstado: [...meuArrayNoEstado, novoElemento] }))
